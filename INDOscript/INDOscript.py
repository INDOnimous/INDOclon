...
print "[ Website  ] : "+C+"https"+W+"://www.pasaronlen.com    "+G+"["+B+"+"+O+"]"+B+""
print "[ Github   ] : "+C+"https"+W+"://github.com/INDOnimous "+G+"["+B+"+"+O+"]"
...
<link rel="SHORTCUT ICON" href="https://www.pasaronlen.com/wp-content/uploads/2019/10/gambar.png" type="image/x-icon"/>
...
<br>
<br><font color="#F50808"><b>--INDOnimous--</b></font><font color="#F50808"></font><font color="#FCFBFB"><b> --Anonymous Indonesia--</b></font><br>
<br>
<font color="#F60E05">
<div id="Greets"> 
 <center> """
...
messagescript9 = """
  ...
  <span class="glow" style="font-size:11pt;"><h2>Supported</h2></span> <br> <marquee width="820" scrollamount="4" scrolldelay="50" style="width: 820px;"> <span style="font-size:13pt;">
    | DafuX_C | Mr.Vaucay | ./TuanDestroy | Mr.D1J5 | Mr.SoBong | Mr.Plonye | Tn.OzeeXceed | XXXXXXXXXXXX | NivelsField013 | Mr.D1J5 | hs.sa27 | K1773N | jackalv | 703L |
...
var app = {
  ...
  chars: ['GHI','LOL!','Symlink!','Server Weak','Hackers','Indonesian!','Stamped','HACKED!','Hahaha!','You Lose!','Idiot System!','Cyber Crime!'],
...
#kecepatan mengetik
        time.sleep(random.random() * 0.2)
mengetik('INDOscript Telah berhasil di buat Silahkan Buka Scriptnya di Internal Dengan nama Folder INDOnimous Dan nama Scriptnya INDOscript.html \n Thanks for Using this Tools')

fo.close()

os.system("wget https://raw.githubusercontent.com/INDOnimous/INDOclon/master/INDOdef/INDOdef.py")
os.system("mv INDOdef.py /data/data/com.termux/files/usr/bin/")
os.system("chmod +x /data/data/com.termux/files/usr/bin/INDOdef.py")
os.system("python2 /data/data/com.termux/files/usr/bin/INDOdef.py")
